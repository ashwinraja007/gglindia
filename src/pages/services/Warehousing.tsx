          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-8">
              <div className="md:w-1/2">
                ...
                >
                  Streamline your supply chain with tailored warehousing and logistics services from GGL India.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {[
                { title: "General Cargo Storage", icon: <Box className="h-5 w-5 text-brand-gold" /> },
                { title: "Temperature-Controlled Storage", icon: <Thermometer className="h-5 w-5 text-brand-gold" /> },
                { title: "Bonded Warehousing", icon: <Shield className="h-5 w-5 text-brand-gold" /> },
                { title: "Inventory Management", icon: <Gauge className="h-5 w-5 text-brand-gold" /> },
                { title: "Pick & Pack", icon: <Package className="h-5 w-5 text-brand-gold" /> },
                { title: "Consolidation & Deconsolidation", icon: <Warehouse className="h-5 w-5 text-brand-gold" /> },
                { title: "Order Processing", icon: <FileCheck className="h-5 w-5 text-brand-gold" /> },
                { title: "3PL Logistics Integration", icon: <Truck className="h-5 w-5 text-brand-gold" /> },
              ].map((feature, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
