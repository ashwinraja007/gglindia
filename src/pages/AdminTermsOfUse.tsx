    ...
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-grow container mx-auto px-4 py-24 max-w-5xl">
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Edit Terms of Use</h1>
            <p className="text-gray-600 mt-2">Manage sections and subsections displayed on the public Terms page.</p>
          </div>
