  ...
  return (
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-12">
        ...
        <h2 className="list-disc ml-6 mt-2">User Eligibility</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">Scope of Terms of Use</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">Modifications</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">GGL (India) Privacy Notice</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">License and Ownership</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">Restrictions on Website Use</h2>
        ...
        <h2 className="list-disc ml-6 mt-2">Outbound Links</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">Inbound Links</h2>
        ...
        <h2 className="list-disc ml-6 mt-2">Termination</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">Disclaimer of Warranties</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">Limitation of Liability</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">Compliance with Laws, Including Export Control</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">Governing Law and Jurisdiction</h2>
        <p>
        ...
        <h2 className="list-disc ml-6 mt-2">General</h2>
        <p>
