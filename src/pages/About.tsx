...
import {
  Globe, Ship, Truck, Package, Clock,
  Shield, Target, Users, Award, CheckCircle
} from 'lucide-react';
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6">
                {[
                  ...
                  <div key={i} className="bg-gray-50 p-6 rounded-xl shadow hover:shadow-md transition duration-300 border border-gray-100">
