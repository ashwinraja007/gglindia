...
const LocationsSection: React.FC = () => {
  ...
  const locationLabels: Record<LocationKey, string> = {
    ...
    Delhi: "Delhi",
    Bangalore: "Bangalore",
    KolkataBranch: "Kolkata (Branch Office)",
    KolkataSales: "Kolkata (Sales Office)",
  };

  const mapIframes: Record<LocationKey, string> = {
    Chennai:
      "https://www.google.com/maps/d/u/0/embed?mid=1QbH4Jh97GdlnhE7ctMmdmYpJW6H2jX8&ehbc=2E312F&noprof=1",
    Kochi:
      "https://www.google.com/maps/d/embed?mid=1uCC98HrDJA35-Wy1zCQRm4I6V_Fi7Gg&ehbc=2E312F&noprof=1",
    NaviMumbai:
      "https://www.google.com/maps/d/u/0/embed?mid=1E2hQWmybKiMlJBH6iVE9U80nlqXCzx4&ehbc=2E312F&noprof=1",
    Delhi:
      "https://www.google.com/maps/d/u/0/embed?mid=1DuD2MsLfqWozRrwLHldQLJg7qOVCly0&ehbc=2E312F&noprof=1",
    Bangalore:
      "https://www.google.com/maps/d/u/0/embed?mid=1VgEO0RnW4UGU1xz543NUgtv01yj0vm8&ehbc=2E312F&noprof=1",
    KolkataBranch:
      "https://www.google.com/maps/d/u/0/embed?mid=1BKt87IfJIGltaDws-ZBJ6Xaj6rN-Y74&ehbc=2E312F&noprof=1",
    KolkataSales:
      "https://www.google.com/maps/d/embed?mid=1bhhXHZJjRiXyNzE7ByTPJRO8xlu7KiI&ehbc=2E312F&noprof=1",
  };
      ...
      <div className="flex flex-col md:flex-row gap-6 max-w-7xl mx-auto px-4">
        <div className="w-full md:w-[30%] p-6 shadow rounded-lg flex flex-col gap-4 bg-slate-100">
          ...
          {Object.keys(locationLabels).map((key) => (
            ...
            >
              {locationLabels[key as LocationKey]}
            </button>
          ))}
        </div>
        ...
        <div className="w-full md:w-[70%] space-y-6">
          ...
          <div className="relative shadow-2xl rounded-lg overflow-hidden h-[480px]">
            ...
            <div className="absolute top-0 left-0 w-full text-center font-semibold text-black py-2 z-30 bg-[#f6b100]">
              GGL - {locationLabels[location]} Location
            </div>
            <iframe
              ...
              title={`${locationLabels[location]} Map`}
